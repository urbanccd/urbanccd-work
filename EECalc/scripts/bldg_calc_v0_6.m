...
function [Ebldg]=bldg_calc_v0_6(In,W)
% bldg_calc calculates energy use according to the CEN/ISO 13790 standards
%
% bldg_calc implements the CEN/ISO 13790 standards along with information
% from a few other locations where the CEN/ISO standards are unclear or
% inappropriate
%
% bldg_calc inputs two structures: In and W which are model inputs and
% monthly weather inputs as created by the parse_inputs and read_epw
% routines
%
% bldg_calc outpus a structure that has the  monthly energy broken
...
% V0.5 21-Dec-2012 RTM made sure it worked with Gnu-Octave
%
%
% V0.2 10-Dec-2012 RTM cleaned up some variable names and removed some
% commented out sections
%
% V0.1 06-Dec-2012 RTM Converted script to routine that does the main building
% calc with inputs of In, W and output of Ebldg.
%
%
% V0.085  13-Nov-2012 RTM
% -continued clean up of variable naming and commenting
%   making sure to clearly denote normative values with n_ 
%   denoting changes from spreadsheet with %%% CHANGE
%   denoting important notes with %%% NOTE

% V0.084  11-Nov-2012 RTM
% -began cleanup of variable naming and commenting 
% -converted hard wired unoccupied people density and parasitic lighting
%   energy be inputs to model 
% -

% V0.082  05-Nov-2012 RTM
% -completed conversion from spreadsheet to MATLAB 


% changes from spreadsheet calculations are denoted by
%%% CHANGE

% key to variable naming 
%n_xxxx = normative value that is hardwired in.  
%v_xxxx = vector (Mx1 or 1xN]
%M_xxxx = matrix (MXN)


%% changes from spreadsheet
% kWh2MJ changed from 1/0.277 to 3.6 (3600 seconds/hr / 1000 W/kW)
%
% added unoccupied people density to replace the fixed 1/9 of the occupied
% density lines 84 to 88 and in computation of heat gains  in 485 to 487
%
% added unoccupied LPD instead of using 6 kWh/m2/yr fixed value
% lines 261-263
%
% changed fraction of hours sun is up to calculate from the actual solar info
% instead of just using 7:00 and 19:00 as fixed values
%
% changed heat capacity calcs to use two values, internal and envelope
% input sheet changed to include two values as well
%
...
% sensors as per prEN 15193:2006.
