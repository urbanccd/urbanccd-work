...
function [Ebldg]=isomodelV01(In,W)
...
% V0.1   Converted older bldgcalc.m to isomodel, this is the version that is
...
qv_ext=-In.vent_exhaust./In.cond_flr_area./3.6;   %vent exhaust rate m3/h/m2, negative indicates out of building
